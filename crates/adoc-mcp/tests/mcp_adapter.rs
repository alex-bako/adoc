...
fn lists_and_reads_all_stable_agent_resources() {
    ...
    let expected = [
        ...
        "adoc://agent/v0/schema/agentdoc.cloud.migration_transition_request.v0.schema.json",
        "adoc://agent/v0/schema/agentdoc.cloud.migration_transition_receipt.v0.schema.json",
        "adoc://agent/v0/schema/agentdoc.cloud.migration_transition_result.v0.schema.json",
